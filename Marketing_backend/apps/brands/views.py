...
class BrandViewSet(WorkspaceScopedMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        # Status is decided by the client's approval, never by the request: a
        # customer awaiting approval creating a second brand must not obtain
        # an ACTIVE one and walk around the spend gate with it.
